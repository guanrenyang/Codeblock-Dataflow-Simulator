...
int main() {
  ...
  std::shared_ptr<Inst> test_inst_add = std::make_shared<CalInst>(0, 2, 0, 1);
  std::shared_ptr<Inst> test_inst_load = std::make_shared<LdInst>(0, 0, 0, 0);
  std::shared_ptr<Inst> test_copy = std::make_shared<CopyInst>(0, 0, 2, 0, 1, 0);
  std::shared_ptr<Inst> test_inst_store = std::make_shared<StInst>(0, 1, 0, 129);
  std::shared_ptr<Inst> test_inst_load_2 = std::make_shared<LdInst>(0, 1, 1, 129);
  ...
  code_block_1->append_instruction(test_inst_store);
